...
//***
        ...
        add_action('admin_menu', function() {
            add_submenu_page('edit.php?post_type=product', 'WOOBE ' . __('Bulk Editor', 'woo-bulk-editor'), 'WOOBE ' . __('Bulk Editor', 'woo-bulk-editor'), 'manage_woocommerce', 'woobe', function() {
        ...
        add_action('admin_bar_menu', function($wp_admin_bar) {
            ...
            if (isset($opt['options']['show_admin_bar_menu_btn']) AND intval($opt['options']['show_admin_bar_menu_btn']) === 1) {
                $args = array(
                    'id' => 'woobe-btn',
                    'title' => 'WOOBE ' . __('Bulk Editor', 'woo-bulk-editor'),
