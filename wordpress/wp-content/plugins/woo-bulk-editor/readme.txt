...
Donate link: https://codecanyon.net/item/woobe-woocommerce-bulk-editor-professional/21779835?ref=realmag777
...
WooCommerce Bulk Editor Professional - WordPress plugin for managing and bulk edit WooCommerce products data in the robust and flexible way!

== Description ==

**For WooCommerce plugin Products Bulk Editor** (WOOBE) is WordPress plugin for WooCommerce created for managing and bulk edit WooCommerce products data in the robust and flexible way! Be professionals with managing data of your woocommerce e-shop!

Latest PHP 7.3.x - FULL COMPATIBILITY! WooCommerce compatibility: from v.3.3.1 to the latest versions.


### Bulk Editor Professional Features:
...
* Documentation: [https://bulk-editor.com/documentation/](https://bulk-editor.com/documentation/) and [https://bulk-editor.com/video-tutorials/](https://bulk-editor.com/video-tutorials/)
* The premium version: [https://bulk-editor.com/a/buy](https://bulk-editor.com/a/buy)
...
In the premium version of the plugin it is possible to manipulate with [all fields of the product](https://bulk-editor.com/)
...
R: [https://bulk-editor.com/video-tutorials/](https://bulk-editor.com/video-tutorials/)

Q: Where can I get the Premium version of WOOBE
...
Q: FAQ?
R: [https://bulk-editor.com/how-to-list/](https://bulk-editor.com/how-to-list/)

Q: Documentation?
R: [https://bulk-editor.com/documentation/](https://bulk-editor.com/documentation/)

Q: I have an idea, can I discuss it with you?
R: [https://bulk-editor.com/forum/](https://bulk-editor.com/forum/)
...
* new column 'Visibility' https://c2n.me/41mlpTi.png
* to variations added shipping class https://c2n.me/41mnEjg.png
* in bulk edit operation to product title now it is possible add its attributes titles https://c2n.me/41mq1Br.png , for example: {attribute:pa-size}
* to products variations tax class added new option as 'Same as parent' https://c2n.me/41mmZ13.png 
* to tab History added pagination and extended filter there
* new hook 'woobe_filter_taxonomies_exists_show' which unlock hidden feature about searching in products existance taxonomies and attributes (its attaching) https://clip2net.com/s/41sMYuT
to current wp theme functions.php file add:
add_filter('woobe_filter_taxonomies_exists_show', function() {
    return true;
});
* restriction of variables combinations for export https://clip2net.com/s/41sNuz5 (when swither variables enabled https://clip2net.com/s/41sNnBm) 
...
* Read article here: [https://bulk-editor.com/update-2-0-4/](https://bulk-editor.com/update-2-0-4/)

= 1.0.3 =
* Some minor fixes
* Filter by authors
* Filter by catalog visibility
* Bulk edit by author (premium only)
* Bulk deleting (premium only)
...
= 1.0.1 =
* [https://bulk-editor.com/update-2-0-1/](https://bulk-editor.com/update-2-0-1/)
