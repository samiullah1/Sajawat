...
jQuery(function ($) {
    ...
    $('.woobe_calculator_set').click(function () {
        ...
        var cell_value = parseFloat($(cell).html().replace(/\,/g, ""));
        ...
        switch (operation) {
            ...
            case 'rp-':
                ...
                cell_value = parseFloat($('#product_row_' + product_id).find("[data-field='regular_price']").html().replace(/\,/g, ""));
            ...
            case 'sp+':
                ...
                cell_value = parseFloat($('#product_row_' + product_id).find("[data-field='sale_price']").html().replace(/\,/g, ""));
