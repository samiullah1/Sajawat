...
<ul>
    <li style="padding: 7px; border: dashed 1px orange; border-radius: 3px; margin-bottom: 9px;">
        <?php
        printf(__('If you like WOOBE %s about what you liked and what you want to see in future versions of the plugin', 'woo-bulk-editor'), WOOBE_HELPER::draw_link([
                    'href' => $WOOBE->show_notes ? 'https://wordpress.org/support/plugin/woo-bulk-editor/reviews/#new-post' : 'https://codecanyon.net/downloads',
                    'target' => '_blank',
                    'title' => __('write us feedback please', 'woo-bulk-editor'),
    ...
    <li style="padding: 7px; border: dashed 1px orange; border-radius: 3px; margin-bottom: 9px;">
        <?php
        printf(__('If you have an idea you can %s', 'woo-bulk-editor'), WOOBE_HELPER::draw_link([
                    'href' => 'https://bulk-editor.com/forum/',
                    'target' => '_blank',
                    'title' => __('share it with us here', 'woo-bulk-editor'),
                    'class' => 'button button-primary',
                    'style' => 'height: 21px; line-height: normal;'
        ]));
        ?>
