...
function woobe_export(format) {
    ...
    /*
     ...
     return false;    console.log(woobe_export_get_combination());
return false;
     }
     */
    //***
...
function woobe_bulk_add_combination_to_apply_export () {
        var select = $('#woobe_bulk_combination_attributes_export');
        ...
        if ($(select).val()) {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#woobe_bulk_to_var_combinations_apply_export').append('<li>' + html + '&nbsp;<a href="javascript: void(0);" class="woobe_bulk_get_att_terms_del button">x</a></li>');
