...
function woobe_init_advanced_panel() {
    ...
    $('#js_check_woobe_show_variations').on('check_changed', function () {
        ...
        if (woobe_show_variations > 0) {
            ...
            $('#woobe_show_variations_mode_export').hide();
        ...
        $('#tabs-export .chosen-select').chosen('destroy');
        $('#tabs-export .chosen-select').chosen();
        //***
...
function woobe_init_special_variation(){
    $("select[data-field='tax_class']").find("option[value='parent']").hide();
    $(".product_type_variation select[data-field='tax_class']").find("option[value='parent']").show();
    if (woobe_show_variations > 0) {
       $('select[name="woobe_bulk[tax_class][value]"]').find("option[value='parent']").show();
    }else{
       $('select[name="woobe_bulk[tax_class][value]"]').find("option[value='parent']").hide(); 
    }
}
