...
jQuery(function ($) {
    if (typeof $.fn.DataTable !== 'undefined') {
        ...
        if (woobe_show_variations > 0) {
            ...
            $('#woobe_show_variations_mode_export').show();
...
function woobe_act_tax_popup(_this) {
    ...
    $('#taxonomies_popup_select_all_terms').unbind('click');
    $('#taxonomies_popup_select_all_terms').prop('checked', false);
    $('#taxonomies_popup_select_all_terms').click(function () {
        if ($(this).is(':checked')) {
            $('#taxonomies_popup_list li input[type="checkbox"]').prop('checked', true);
        }else{
            $('#taxonomies_popup_list li input[type="checkbox"]').prop('checked', false);
        }
        check_popup_list_checked_only($('#taxonomies_popup_list_checked_only'));
    });
...
var cell_dropdown = $(_this).parents('.woobe_multi_select_cell').find('.woobe_multi_select_cell_dropdown');
    ...
    $(cell_dropdown).find('.woobe_multi_select_cell_select').unbind('click');
    $(cell_dropdown).find('.woobe_multi_select_cell_select').click(function () {
        $(select).find('option').prop('selected', true);  
        $(select).trigger('chosen:updated');
        return false;
    });
    $(cell_dropdown).find('.woobe_multi_select_cell_deselect').unbind('click');
    $(cell_dropdown).find('.woobe_multi_select_cell_deselect').click(function () {
