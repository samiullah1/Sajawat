...
**WooCommerce Currency Switcher** is WooCommerce multi currency plugin, that allows your site visitors switch products prices currencies according to set currencies rates in the real time and pay in the selected currency (optionally). Allows to add any currency for WooCommerce store. Ideal solution to make the serious WooCommerce store site in multiple currencies!
...
&#9989;&nbsp;**Design**: graphically WooCommerce Currency Switcher can be represented in 3 different ways: drop-down, flags, [side switcher](https://demo.currency-switcher.com/). For each currency it is possible to set flag.
